...
if page == "🏠 Home":
    ...
    with col1:
        st.markdown("<h1 style='color:#00ff88;'>🛡️ PhishDetect</h1>", unsafe_allow_html=True)
        st.markdown("### ML-Powered Email Threat Detection")
...
- **Sender Analysis** detects header-level red flags
...
''')
    with col2:
        ...
        st.metric("Live Model Accuracy", "98%", "on test set")
...
# ---------- SCAN EMAIL ----------
    ...
    if input_method == "✏️ Paste Text":
        email_text = st.text_area(
            "Paste email content (include headers for sender analysis):",
            height=250,
            placeholder="Paste the full email including headers like From:, Reply-To:, Subject:..."
        )
    else:
...
# ---------- ABOUT ----------
    ...
    st.markdown('''
**PhishDetect** is a final year project that uses machine learning to detect
phishing emails — including a new breed of AI-generated threats that often bypass traditional filters.
